...
const version = '2.15.306';
exports.version = version;
const build = '9cc5260b6';
exports.build = build;
...
exports.CommandManager = exports.ColorManager = exports.AnnotationEditorUIManager = void 0;
...
class InkEditor extends _editor.AnnotationEditor {
  ...
  canvasPointerdown(event) {
    if (event.button !== 0 || this.#disableEditing) {
      return;
    }
...
const pdfjsVersion = '2.15.306';
const pdfjsBuild = '9cc5260b6';
{
  if (_is_node.isNodeJS) {
    const {
      PDFNodeStream
